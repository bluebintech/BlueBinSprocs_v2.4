...
case when @Facility is not null or @Facility <> '' then (select FacilityName from bluebin.DimFacility where FacilityID = COALESCE(@Facility,BUSINESS_UNIT)) else BUSINESS_UNIT end as FacilityName,
