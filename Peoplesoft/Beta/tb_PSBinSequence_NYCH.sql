...
from 
(select COALESCE(@Facility,(select FacilityID from bluebin.DimFacility where FacilityName = rs.BUSINESS_UNIT)) as COMPANY, 
		COALESCE(rs.INV_ITEM_ID,r.INV_ITEM_ID) as ITEM,
