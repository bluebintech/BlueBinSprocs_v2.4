...
Orders
	 ...
	 SELECT Row_number()
         ...
         FROM   dbo.PO_LINE_DISTRIB PO_LN_DST
                ...
                INNER JOIN dbo.PO_HDR
                        ON PO_LN.PO_ID = PO_HDR.PO_ID AND PO_LN.BUSINESS_UNIT = PO_HDR.BUSINESS_UNIT
    ...
    --                      AND PO_LN_DST.LOCATION = FirstScans.LocationID
		...
		GROUP BY 
				...
				select * from bluebin.DimBin where LocationID = '16401PED02' and ItemID = '100177'
				select * from PO_HDR where PO_ID = '0000008230' 
				select * from PO_LINE where PO_ID = '0000008230' and LINE_NBR = '8'
				select * from PO_LINE_DISTRIB where PO_ID = '0000008230' and LINE_NBR = '8'
				select * from PO_LINE_DISTRIBstage where PO_ID = '0000008230' and LINE_NBR = '8'

				exec sp_MergePO_LINE_DISTRIB
				,
