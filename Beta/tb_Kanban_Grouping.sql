...
GO
--exec tb_Kanban
--select * from tableau.Kanban  select * from etl.JobDetails order by 3 desc
...
FROM   bluebin.DimBin
	   ...
	   left join bluebin.TimeStudyGroup tsg on bluebin.DimBin.BinFacility = tsg.FacilityID and bluebin.DimBin.LocationID = tsg.LocationID
