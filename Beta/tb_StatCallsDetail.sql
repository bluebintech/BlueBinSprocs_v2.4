...
CREATE PROCEDURE tb_StatCallsDetail
AS
BEGIN
SET NOCOUNT ON
...
WHERE SYSTEM_CD = 'IC' AND DOC_TYPE = 'IS' and dl.BlueBinFlag = 1 and a.TRANS_DATE > getdate() -90
GROUP BY
    a.FROM_TO_CMPY,
	df.FacilityName,
	--a.LOCATION,
    ...
    c.ACCT_UNIT,
    c.DESCRIPTION
Order by a.TRANS_DATE,a.DOCUMENT,a.LINE_NBR desc
